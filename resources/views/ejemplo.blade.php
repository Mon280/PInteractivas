<head>
 ...
 <!-- Styles -->
  <style>
      ...
      .tamCelda{width: 650px;  overflow: auto;}
  </style>  
</head>
        ...
        <div class='container'>
            <table class="table  table-striped">
                <thead>
                    <tr>
                        <th scope="col"> ID </td>
                        <th scope="col" class="tamCelda"> Título </td>
                        <th scope="col"> Ciudad </td>
                        <th scope="col"> País </td>
                        <th scope="col"> Autor </td>
                        <th scope="col">  </td>
                    <tr>
                </thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('viaje', ['id'=>$articulo->id]) }}" class="btn btn-dark">Ver</a>
                            <a href="/edita/{{$articulo->id}}" class="btn btn-dark">Editar</a>
                            <a href="/elimina/{{$articulo->id}}" class="btn btn-danger">Eliminar</a>
                        </td>
                    <tr>
                @endforeach
                </tbody>
